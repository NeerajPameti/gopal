...
public class LoanController {
	...
	public String New_loan_application(@Validated LoanApplicationInput l, HttpServletRequest request) {
	...
	public String approve_loan_application(@RequestParam("loanId") int accountType,
			@RequestParam("customerId") Long custid, HttpServletRequest request) {
